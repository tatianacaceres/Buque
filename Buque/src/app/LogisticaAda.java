...
public class LogisticaAda {
    ...
    public void cargarContenedores(Buque buqueAda){
        ...
        for (int i = 0; i<6; i++){
            ...
            System.out.println("Ingrese el id del contenedor" + (i+1));

            idContenedor = Teclado.nextInt();

            System.out.println("Ingrese el peso del contenedor en kg");

            peso = Teclado.nextDouble();

            puerto = seleccionaPuerto();

            Contenedor contenedor = new Contenedor (idContenedor, peso, puerto);
    ...
    public Puerto seleccionaPuerto(){
        ...
        System.out.println("Ingrese el puerto de destino: 1, 2 o 3");
        int nroPuerto;
